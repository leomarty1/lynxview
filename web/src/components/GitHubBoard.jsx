// GitHubBoard.jsx — panneau board GitHub (cache 5min).
...
export default function GitHubBoard({ baseUrl, token, onUseIssue }) {
      ...
      <button
        ...
        onClick={() =>
          onUseIssue?.({
            ...
            prompt: "",
            note: "Lance /onboarding-client pour gérer une étape",
          })
        }
